...
class Visualizer():
    ...
    def save_images(self, visuals, image_path, i):
        print('save images to', image_path)
        if not os.path.exists(image_path):
            os.makedirs(image_path, exist_ok=True)
 
        for label, image_numpy in visuals.items():
            util.save_image(image_numpy, os.path.join(image_path, f'{i}.jpg'))


    def save_mask(self, visuals, image_path, i):
        print('save images to', image_path)
        if not os.path.exists(image_path):
            os.makedirs(image_path, exist_ok=True)
 
        for label, image_numpy in visuals.items():
            util.save_image(image_numpy, os.path.join(image_path, f'{i}.png'))
